...
(2, 'Masonry Portfolio', 'masonry-portfolio', 'Layout masonry responsivo per portfolio - desktop 4 colonne, tablet 3, mobile 2', '{"layout":"masonry","columns":{"desktop":4,"tablet":3,"mobile":2},"gap":{"horizontal":8,"vertical":8},"aspect_ratio":"1:1","style":{"rounded":true,"shadow":false,"hover_scale":true,"hover_fade":false},"photoswipe":{"loop":true,"zoom":true,"share":true,"counter":true,"arrowKeys":true,"escKey":true,"bgOpacity":0.9,"spacing":0.1,"allowPanToNext":true},"masonry":{"type":"balanced"}}', '["photoswipe","masonry-grid"]'),
