...
class Installer
{
    ...
    /**
     * Configure .htaccess files for subdirectory installations
     */
    private function configureHtaccess(array $data): void
    {
        ...
        if ($subdirectory === '') {
            // Root installation, no .htaccess configuration needed
            return;
        }
        ...
        try {
            ...
            // 2. Update public/.htaccess with correct RewriteBase
    ...
    /**
     * Create root .htaccess to redirect requests to public/
     */
    private function createRootHtaccess(string $subdirectory): void
    {
...
# Auto-generated by Cimaise installer for subdirectory installation
...
<IfModule mod_rewrite.c>
    ...
    RewriteCond %{REQUEST_URI} !^{$subdirectoryEscaped}/public/
...
# Apache 2.2 fallback (requires mod_access_compat on 2.4)
<IfModule !mod_authz_core.c>
    <FilesMatch "^\.">
        Order allow,deny
        Deny from all
...
HTACCESS;
    ...
    /**
     * Update public/.htaccess with correct RewriteBase
     */
